...
w=shapefile.Writer(shapeType=1) #untuk membuat tyoe shape yang akan dibuat
...
w.record("ngok","dua")  #baris pertama kolom 2 berisi "ngok", kolom kedua berisi "dua"
...
w.save("soal2") #Untuk menambahkan record tergantung dengan type ESRInya.